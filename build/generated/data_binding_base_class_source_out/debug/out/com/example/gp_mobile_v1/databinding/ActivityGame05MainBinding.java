...
public final class ActivityGame05MainBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityGame05MainBinding(@NonNull LinearLayout rootView, @NonNull Button btnHome,
  ...
  @NonNull
  public static ActivityGame05MainBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityGame05MainBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_game05_main, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityGame05MainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGame05MainBinding((LinearLayout) rootView, btnHome, buttonOption1,
